...
if (!$buildOnly) {
    ...
    & ./setup.ps1 -nitroPacker /nitropacker/HaroohieClub.NitroPacker.Cli/bin/Debug/net10.0/NitroPacker
    
    & ./build_arc.ps1 -haruhiCli /utility/HaruhiChokuretsuCLI/bin/Debug/net10.0/HaruhiChokuretsuCLI -stringsFolder /strings -assetsFolder /assets -devkitArm /opt/devkitpro/devkitARM/ -resxLangCode $env:LANG -version $env:ROM_VERSION
...
& ./build.ps1 -nitroPacker /nitropacker/HaroohieClub.NitroPacker.Cli/bin/Debug/net10.0/NitroPacker -haruhiCli /utility/HaruhiChokuretsuCLI/bin/Debug/net10.0/HaruhiChokuretsuCLI -stringsFolder /strings -fontReplacementMap $charset -langCode $env:LANG
