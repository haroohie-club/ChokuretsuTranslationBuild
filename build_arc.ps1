...
$splashScreenArgs = @("version-screen", "-v", "$version", "-s", "$archiveFolder\graphics\$resxLangCode\splash\splash_screen.png", "-f", "$archiveFolder\graphics\$resxLangCode\splash\Nunito-Black.ttf", "-o", "$archiveFolder\graphics\$resxLangCode\8b7_newpal_tidx0_splash_screen.png")
...
Remove-Item -Path "$archiveFolder\graphics\$resxLangCode\8b7_newpal_tidx0_splash_screen.png"